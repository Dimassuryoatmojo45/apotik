...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('apotik', [ViewController::class, 'buat_apotik']);
    Route::get('vendor', [ViewController::class, 'buat_vendor']);
    Route::get('transaksi', [ViewController::class, 'buat_transaksi'])->name('buat_transaksi');
    Route::get('transaksi_obat', [ViewController::class, 'buat_transaksi_obat'])->name('buat_transaksi_obat');

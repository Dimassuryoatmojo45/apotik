...
<body class=" layout-boxed">
            ...
            <div class="container-xl">
                ...
                <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        ...
                        <img src="./img/logo.png" width="110" height="33" viewBox="0 0 232 68"
                            class="navbar-brand-image">
                    </a>
                </div>
                        ...
                        <div class="row flex-fill align-items-center">
                            <div class="col">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item {{ request()->is('buat_apotik') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('buat_apotik') }}">
                                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                                <!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <li class="nav-item {{ request()->is('buat_vendor') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('buat_vendor') }}">
                                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                                <!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <script src="./libs/jsvectormap/dist/jsvectormap.min.js" defer></script>
